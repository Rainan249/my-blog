...
import { isTokenSet } from '../../api/github.js'
...
onMounted(() => {
  ...
  } else if (!isTokenSet() && route.name !== 'admin-setup') {
...
const menuItems = [
  ...
  { name: '导入 MD', path: '/admin/import', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' },
  { name: '导入 ZIP', path: '/admin/import-zip', icon: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4' },
